...
def record(waveFilePath):
    ...
    frames = []
    while True:
        if GPIO.input(Button_x1_Pin_25) == True:
            Button_x1_Pin_25_State = True
            break

        if GPIO.input(Button_x2_Pin_8) == True:
            Button_x2_Pin_8_State = True
            break

        if GPIO.input(Button_x3_Pin_7) == True:
        ...
        if GPIO.input(Button_x4_Pin_12) == True:
            Button_x4_Pin_12_State = True
            break

        if GPIO.input(Button_x5_Pin_16) == True:
...
def speechRecYesNo():
    ...
    if 'yes' in text or Button_x1_Pin_25_State == True:
        result = 3

    if 'no' in text or Button_x2_Pin_8_State == True:
        result = 4
